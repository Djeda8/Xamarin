...
using PreferencesService.Views.Main;
using PreferencesService.Views.Base;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;
using Xamarin.Forms;
using PreferencesService.ViewModels.Settings;
using PreferencesService.Views.Settings;
using PreferencesService.ViewModels.Main;

namespace PreferencesService.Services.Navigation
{
